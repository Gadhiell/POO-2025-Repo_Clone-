...
class SettingsMenu:
    ...
    #los enemigos colisionan(agregar barra de vida al personaje Tipo sprite),utilizar enemigos voladores,Agregar logo en la pantalla de titulo,pantalla de game over